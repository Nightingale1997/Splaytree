 ...
 * as well as for balancing the search
 * using methods for rotating/lifting the
 * trees in order.
 *
...
public class SplayWithGet<E extends Comparable<? super E>> extends BinarySearchTree<E> implements CollectionWithGet<E> {
    ...
    private void splay(Entry entry) {
        ...
        if (entry.parent != null) {
            ...
            //Does entry have a grandparent
            if (parent.parent != null) {

                Entry grandParent = parent.parent;

                //Is parent a right child
                ...
                //Check which splay function should be preformed based on parent relationship.
